...
DUMMY_PAKETS = [
    {"nama": "Agus Santoso", "nomor_telepon": "081234567890",
     ...
     "latitude": -6.753464795836721, "longitude": 110.84357211121313,
    ...
    {"nama": "Siti Rahayu", "nomor_telepon": "081398765432",
     ...
     "cod": False, "harga": 0, "ongkir": 20000,
     "latitude": -6.7290871, "longitude": 110.852325, "catatan": None},
    {"nama": "Andi Wijaya", "nomor_telepon": "082111223344",
     ...
     "latitude": -6.315866487642469, "longitude": 106.77239111343025,
    ...
    {"nama": "Dewi Lestari", "nomor_telepon": "085622334455",
     ...
     "cod": False, "harga": 0, "ongkir": 15000,
     "latitude": -6.8078, "longitude": 110.8378, "catatan": None},
    {"nama": "Usman Bin Myra", "nomor_telepon": "087833445566",
     ...
     "cod": True, "harga": 1200000, "ongkir": 35000,
     "latitude": -7.4087, "longitude": 111.4447, "catatan": "COD tunai"},
]
        ...
        for item in DUMMY_PAKETS:
            ...
            if paket is not None:
                ...
                if paket.ongkir != ongkir:
                    paket.ongkir = ongkir
                    changed = True
                if paket.service_type != service_type:
                    paket.service_type = service_type
                    changed = True
                if (paket.latitude != item.get("latitude")
                        or paket.longitude != item.get("longitude")):
                    paket.latitude = item.get("latitude")
                    paket.longitude = item.get("longitude")
                    changed = True
                if changed:
                    updated += 1
                continue
